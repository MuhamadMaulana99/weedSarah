        ...
        <>
            ...
            <GalleryContainer>
                <Box>
                    ...
                    <ImagesContainer>
                        <div className="image">
                            <img src="gambar/pengantin/1.jpg" alt="photos-1" />
                        </div>
                        <div className="image">
                            <img src="gambar/pengantin/3.jpg" alt="photos-2" />
                        </div>
                        <div className="image">
                            <img src="gambar/pengantin/5.jpg" alt="photos-3" />
                        </div>
                        <div className="image">
                            <img src="gambar/pengantin/7.jpg" alt="photos-4" />
                        </div>
                        <div className="image">
